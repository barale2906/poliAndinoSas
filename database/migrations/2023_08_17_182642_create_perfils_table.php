...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('perfils', function (Blueprint $table) {
            ...
            $table->time('fecha_documento')->comment('expedición documento de identidad');
            $table->string('lugar_expedicion')->comment('lugar expedición documento de identidad');
            $table->string('nombre')->comment('nombre del usuario');
            $table->string('apellido')->comment('apellido del usuario');
            $table->longtext('direccion')->comment('direccion del usuario');
            $table->time('fecha_nacimiento')->comment('fecha de nacimiento');
            $table->string('barrio')->comment('barrio - sector residencia');
